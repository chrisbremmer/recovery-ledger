// AuthError — typed failure shape for OAuth / token-store flows. Lives
// in the domain layer per #18 so formatters + CLI command shims can
// import the contract without reaching into `src/infrastructure/`. The
// infrastructure carrier at `src/infrastructure/whoop/errors.ts` re-
// exports these symbols verbatim so the existing
// `import { AuthError, formatAuthError } from '.../whoop/errors.js'`
 ...
 * two module-graph instances of this file produce different class
