...
- Confirm whether to deepen research before Phase 3 planning (Drizzle migrator crash-recovery contract, WHOOP `updated_at` semantics for incremental sync, DST/tz exclusion fixture design).
